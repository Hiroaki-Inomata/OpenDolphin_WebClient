...
### このリポジトリの開発につきまして
2026年3月10日、GPT Proシリーズによる方針策定、およびCodexをメインにしたバイブコーディングで作業を行っております。
PR、Issue大歓迎で、マージも積極的にさせていただきますが、H.Inomata 様のPR [#68](https://github.com/circlemouth/OpenDolphinNext/pull/68)のように、マージ直後に上書きされてしまうという事案も度々発生するかと思います。
